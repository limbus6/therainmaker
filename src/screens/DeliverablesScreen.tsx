...
export default function DeliverablesScreen() {
  ...
  const sortedDeliverables = [...deliverables].sort((a, b) => {
    if (a.phase === phase && b.phase !== phase) return -1;
    if (b.phase === phase && a.phase !== phase) return 1;
  ...
  return (
    <div className="space-y-6 max-w-[1200px]">
      <div>
        ...
        <p className="text-[12px] text-text-muted mt-1">Track all formal process outputs. Current phase deliverables are shown first.</p>
      </div>
            ...
            <div className="flex items-start justify-between mb-3">
              <div>
                ...
                <div className="flex items-center gap-2 mt-1">
                  ...
                  <StatusChip label={`Phase ${del.phase}`} variant={del.phase === phase ? 'accent' : 'muted'} />
