...
export default function BoardSubmissionModal({ onClose }) {
    ...
    const [selectedLeadId, setSelectedLeadId] = useState(() => useGameStore.getState().leads[0]?.id ?? null);
