...
export default function PhaseTransitionOverlay({ fromPhase, toPhase, onComplete }) {
    ...
    return (_jsxs("div", { onClick: onComplete, className: `fixed inset-0 z-[60] cursor-pointer select-none flex items-center justify-center bg-bg-primary transition-opacity duration-300 ${stage === 'fade-in' ? 'opacity-0' : stage === 'hold' ? 'opacity-100' : 'opacity-0'}`, children: [_jsx("div", { className: "absolute inset-0 overflow-hidden pointer-events-none", children: _jsx("div", { className: "absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] rounded-full bg-accent-primary/10 blur-[120px]" }) }), _jsxs("div", { className: "relative text-center space-y-6", children: [_jsxs("div", { className: "text-[11px] font-mono uppercase tracking-widest text-text-muted", children: ["Phase ", fromPhase, ": ", PHASE_NAMES[fromPhase], _jsx("span", { className: "mx-3 text-accent-primary", children: "\u2192" })] }), _jsxs("div", { children: [_jsxs("div", { className: "text-[10px] font-mono uppercase tracking-[0.3em] text-accent-primary mb-3", children: ["Phase ", toPhase] }), _jsx("h1", { className: "text-4xl font-display font-bold text-text-primary tracking-tight", children: PHASE_NAMES[toPhase] })] }), _jsx("p", { className: "text-[14px] text-text-secondary max-w-md mx-auto leading-relaxed", children: PHASE_TAGLINES[toPhase] }), PHASE_ENTRY_NARRATIVES[toPhase] && (_jsx("p", { className: "text-[12px] text-text-accent/80 max-w-md mx-auto italic leading-relaxed", children: PHASE_ENTRY_NARRATIVES[toPhase] })), _jsxs("div", { className: "pt-2", children: [_jsx("div", { className: "w-24 h-px bg-accent-primary/40 mx-auto mb-3" }), _jsx("p", { className: "text-[10px] font-mono text-text-muted uppercase tracking-widest animate-pulse", children: "Click anywhere to skip" })] })] })] }));
}
