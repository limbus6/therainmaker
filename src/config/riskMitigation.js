function founderCommitmentPlans() {
    return [
        {
            ...
            catastrophicDescription: 'Ricardo rejected the commitment structure and terminated the engagement immediately.',
        },
        {
...
function competingAdvisorPlans() {
    return [
        {
        ...
        },
        {
            ...
            catastrophicDescription: 'Ricardo read the golf club invitation as superficial and misaligned. The relationship broke down immediately.',
        },
    ];
}
...
export function getRiskMitigationPlans(risk) {
...
//# sourceMappingURL=riskMitigation.js.map