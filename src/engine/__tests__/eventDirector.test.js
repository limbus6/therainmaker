...
describe('EventDirector', () => {
    ...
    it('suppresses danger events when an unmitigated major risk exists', () => {
        ...
        const stateWithMajorRisk = {
            ...mockState,
            risks: [
                { id: 'r1', name: 'Critical Risk', category: 'legal', severity: 'critical', probability: 80, mitigated: false, surfacedWeek: 1, surfacedPhase: 1 },
            ],
        };
...
//# sourceMappingURL=eventDirector.test.js.map